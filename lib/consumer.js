...
var createChannelTransaction = function(opts) {
  ...
  //TODO: we can re-balance the outputs automatically if this is helpful
  ...
  // we only want to sign the consumer output and not any of the others
  chanTx.sign(consumerPrivateKey, Signature.SIGHASH_SINGLE);
  return chanTx;
};
